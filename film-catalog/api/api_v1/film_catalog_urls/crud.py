...
class FilmStorage(BaseModel):
    ...
    def update(
        ...
        # Альтернативный вариант обновления с созданием нового экземпляра
        # (не совсем то, так как здесь выполняется обновление)
        # updated_film = film.model_copy(
        #     update=film_in.model_dump(),
        # )
